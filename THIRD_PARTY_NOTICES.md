...
This notice summarizes direct dependencies and important source/provenance boundaries for the default Readwide 1.0.2 build. It does not replace a fully resolved transitive dependency report.

## Default build boundary

The default Readwide 1.0.2 package is the FOSS-oriented public line:
...
See `docs/FOSS_STATUS.md`, `docs/LICENSE_REPORT_READWIDE_1_0_2.md`, and `docs/SBOM_READWIDE_1_0_2.spdx.json`.
