...
- **Large-file bookmark accuracy**: large-file bookmarks resolve by their surrounding text, so they land on the correct page even after the page layout changes (for example a different font size or margin).
