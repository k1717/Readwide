...
> Historical 1.0.2 snapshot. For current scope and verification boundaries, see [release notes](GITHUB_RELEASE_NOTES_READWIDE_1_0_18.md). The original findings below are retained as history.
