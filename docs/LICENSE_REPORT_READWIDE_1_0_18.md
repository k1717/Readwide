# Readwide 1.0.18 direct dependency license report

This report is reconciled from the dependencies declared in `app/build.gradle` plus source-bundled notices that are relevant to the default Readwide 1.0.18 build.
...
The runtime/test dependency declarations are unchanged from 1.0.17. This edition
updates the app identity and current decoder scope; it does not claim a new
resolved dependency audit or independent APK inspection.
...
1. Include `LICENSE`, `NOTICE`, `THIRD_PARTY_NOTICES.md`, `PRIVACY.md`, `docs/FOSS_STATUS.md`, this report, and `docs/SBOM_READWIDE_1_0_18.spdx.json`.
