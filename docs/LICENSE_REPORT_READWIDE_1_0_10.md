# Readwide 1.0.10 direct dependency license report

This report is generated from the dependencies declared in `app/build.gradle` plus source-bundled notices that are relevant to the default Readwide 1.0.10 build.
...
| `com.tom-roush:pdfbox-android:2.0.27.0` | PDF text extraction with glyph positions for in-document find (rendering still uses the platform PdfRenderer) | Apache-2.0 |
