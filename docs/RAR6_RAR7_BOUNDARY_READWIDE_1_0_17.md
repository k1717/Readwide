...
This is the historical 1.0.17 boundary. Readwide 1.0.18 replaces
the 64 MiB retained-history ceiling with encrypted temporary paging; see
current history/storage scope. The historical
results below do not validate that newer implementation.
