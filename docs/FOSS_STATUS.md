# FOSS status for Readwide 1.0.5

This is the project-level FOSS status note for the default Readwide 1.0.5 source package and default release build. It is not legal advice; it records the current release position and the checks a reviewer should make.

## Current assessment

The default Readwide 1.0.5 source package is intended to remain FOSS-friendly:
...
See `docs/LICENSE_REPORT_READWIDE_1_0_5.md`, `docs/SBOM_READWIDE_1_0_5.spdx.json`, and `THIRD_PARTY_NOTICES.md` for detail.
...
- `docs/LICENSE_REPORT_READWIDE_1_0_5.md` and `docs/SBOM_READWIDE_1_0_5.spdx.json` are direct-dependency/source-declared drafts, not a fully resolved transitive Gradle SBOM.
