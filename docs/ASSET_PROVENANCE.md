...
The generated launcher assets are derived from the project-owned source reference image. No external stock image, third-party logo, or copied upstream icon path is required for the Readwide launcher artwork.
