...
public class PrefsManager {
    ...
    // matcher and is intentionally not user-toggleable.
    public boolean getReaderSearchCaseSensitive() { return prefs.getBoolean("reader_search_case_sensitive", false); }
    public void setReaderSearchCaseSensitive(boolean v) { prefs.edit().putBoolean("reader_search_case_sensitive", v).apply(); }

    public boolean getReaderSearchWholeWord() { return prefs.getBoolean("reader_search_whole_word", false); }
    public void setReaderSearchWholeWord(boolean v) { prefs.edit().putBoolean("reader_search_whole_word", v).apply(); }

    public boolean getReaderSearchRegex() { return prefs.getBoolean("reader_search_regex", false); }
    public void setReaderSearchRegex(boolean v) { prefs.edit().putBoolean("reader_search_regex", v).apply(); }
