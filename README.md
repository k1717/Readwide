...
- `docs/GITHUB_RELEASE_NOTES_READWIDE_1_0_10.md` — copy-ready GitHub release notes.
...
- `docs/LICENSE_REPORT_READWIDE_1_0_10.md` and `docs/SBOM_READWIDE_1_0_10.spdx.json` — direct-dependency license/SBOM drafts.
